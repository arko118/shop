...
<form action=/shopping/servlet/categoryid6changedaysbefore method=get>
...
%>
<%
out.println("Product price: "+daysbefore+" ");


out.println("<input type=hidden name=id3 value="+id3+"> ");
out.println("<input type=hidden name=id2 value="+id2+"> ");
out.println("<input type=hidden name=daysbefore value="+daysbefore+"> ");
