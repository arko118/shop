...
s[0]='<div align="center"><iframe src=/shopping/shop/jpfile/customerinput.jsp width=1000 height=800 frameborder=0 scrolling="No"></iframe></div>'
...
if(document.getElementById&&!document.all){
document.writeln('<div style="position:relative;" onmouseover="sspeed=0;" onmouseout="sspeed=1">')
