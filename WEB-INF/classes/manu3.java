...
public class manu3 extends HttpServlet{
...
while(rs.next()){
	...
	if(i==39){	
	out.println("<td><a  href=/shopping/servlet/manu2><img src=/shopping/shop/doc/arrow.gif width=45 height=10></a></td>");		
	}
if(i==40){	
	out.println("<td><a class=style1 target=/shopping/servlet/frame3?id=1 href=/shopping/servlet/frame6?id="+i+"><img src=/shopping/shop/manuimage/manu3_image/"+i+".jpg width=100 height=100><br>"+name+"</a></td>");		
	}
if(i==41){	
	out.println("<td><a class=style1 target=/shopping/servlet/frame3?id=1 href=/shopping/servlet/frame6?id="+i+"><img src=/shopping/shop/manuimage/manu3_image/"+i+".jpg width=100 height=100><br>"+name+"</a></td>");		
	}
...
if(i==47){	
	...
	if(i==48){	
	out.println("<td><a href=/shopping/servlet/manu4><img src=/shopping/shop/doc/arrowright.gif width=45 height=10></a></td>");		
	}
