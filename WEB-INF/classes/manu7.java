...
public class manu7 extends HttpServlet{
...
while(rs.next()){
	...
	if(i==76){	
	out.println("<td><a  href=/shopping/servlet/manu6><img src=/shopping/shop/doc/arrow.gif width=45 height=10></a></td>");		
	}
	
if(i==77){	
	out.println("<td><a class=style1 target=/shopping/servlet/frame3?id=1 href=/shopping/servlet/frame6?id="+i+"><img src=/shopping/shop/manuimage/manu7_image/"+i+".jpg width=100 height=100><br>"+name+"</a></td>");		
	}
if(i==78){	
	out.println("<td><a class=style1 target=/shopping/servlet/frame3?id=1 href=/shopping/servlet/frame6?id="+i+"><img src=/shopping/shop/manuimage/manu7_image/"+i+".jpg width=100 height=100><br>"+name+"</a></td>");		
	}
...
if(i==84){	
	...
	if(i==85){	
	out.println("<td><a href=/shopping/servlet/manu8><img src=/shopping/shop/doc/arrowright.gif width=45 height=10></a></td>");		
	}
