...
public class manu6 extends HttpServlet{
...
while(rs.next()){
	...
	if(i==67){	
	out.println("<td><a  href=/shopping/servlet/manu5><img src=/shopping/shop/doc/arrow.gif width=45 height=10></a></td>");		
	}
	
if(i==68){	
	out.println("<td><a class=style1 target=/shopping/servlet/frame3?id=1 href=/shopping/servlet/frame6?id="+i+"><img src=/shopping/shop/manuimage/manu6_image/"+i+".jpg width=100 height=100><br>"+name+"</a></td>");		
	}
if(i==69){	
	out.println("<td><a class=style1 target=/shopping/servlet/frame3?id=1 href=/shopping/servlet/frame6?id="+i+"><img src=/shopping/shop/manuimage/manu6_image/"+i+".jpg width=100 height=100><br>"+name+"</a></td>");		
	}
...
if(i==75){	
	...
	if(i==76){	
	out.println("<td><a href=/shopping/servlet/manu7><img src=/shopping/shop/doc/arrowright.gif width=45 height=10></a></td>");		
	}
